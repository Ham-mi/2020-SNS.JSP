			...
			<div class="row text-center">
				<div class="col-lg-12">
					<div class="home_content">
						<div class="home_title">Facebook</div>
						<div class="index-over"><a href="../Main/index.jsp">Home</a> <i class="fa fa-angle-right" aria-hidden="true"></i> SNS <i class="fa fa-angle-right" aria-hidden="true"></i> <a href="../SNS/facebook.jsp">페이스북</a></div>	
					</div>
				</div>
			</div>
		</div>
				...
				<div class="col">
					<div class="domain_pricing_content">
						<ul class="d-flex flex-md-row flex-column align-items-center justify-content-md-between justify-content-center nav nav-tabs">
						  <li class="nav-item">
						    <a class="nav-link  nav-active" href="facebook.jsp"><i class="fab fa-facebook-square" aria-hidden="true"></i>  페이스북</a>
						  </li>
						  <li class="nav-item">
						    <a class="nav-link" href="instagram.jsp"><i class="fab fa-instagram" aria-hidden="true"></i>  인스타그램</a>
						  </li>
						  <li class="nav-item">
						    <a class="nav-link" href="twitter.jsp"><i class="fab fa-twitter" aria-hidden="true"></i>  트위터</a>
						  </li>
						  <li class="nav-item">
						    <a class="nav-link" href="ect.jsp"><i class="fa fa-cloud" aria-hidden="true"></i>  기타</a>
						  </li>
						</ul>
					</div>
				</div>
				...
				<div class="check">
					<div class="catecory">
						<div class="row">
							<div class="col-1"></div>
							<div class="col cate">
								<input type="button" value="⦁ 전체(12)" id="cate1" class="cate_but" onclick="catebut_active1()">
							</div>
							<div class="col cate">
								<input type="button" value="⦁ 의류(6)" id="cate2" class="cate_but" onclick="catebut_active2()">
							</div>
							<div class="col cate">
								<input type="button" value="⦁ 악세서리(3)" id="cate3" class="cate_but" onclick="catebut_active3()">
							</div>
							<div class="col cate">
								<input type="button" value="⦁ 잡화(3)" id="cate4" class="cate_but" onclick="catebut_active4()">
							</div>
							<div class="col-1"></div>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-lg-3 col-sm-6 col-12 card_display">
							<div class="card s-Citem">
							 	...
							 	<div class="card-body">
							    	<p class="card-text">#페이스북 #의류 #공구 #국내</p>
							 	</div>
							</div>
						</div>
						<div class="col-lg-3 col-sm-6 col-12 card_display">
							<div class="card s-Citem">
							 	...
							 	<div class="card-body">
							    	<p class="card-text">#페이스북 #의류 #직구 #해외</p>
							 	</div>
							</div>
						</div>
						<div class="col-lg-3 col-sm-6 col-12 card_display">
							<div class="card s-Citem">
							 	...
							 	<div class="card-body">
							    	<p class="card-text">#페이스북 #의류 #공구 #해외</p>
							 	</div>
							</div>
						</div>
						<div class="col-lg-3 col-sm-6 col-12 card_display">
							<div class="card s-Citem">
							 	...
							 	<div class="card-body">
							    	<p class="card-text">#페이스북 #의류 #수제 #해외</p>
							 	</div>
							</div>
						</div>
						<div class="col-lg-3 col-sm-6 col-12 card_display">
							<div class="card s-Citem">
							 	...
							 	<div class="card-body">
							    	<p class="card-text">#페이스북 #의류 #직구 #국내</p>
							 	</div>
							</div>
						</div>
						<div class="col-lg-3 col-sm-6 col-12 card_display">
							<div class="card s-Citem">
							 	...
							 	<div class="card-body">
							    	<p class="card-text">#페이스북 #악세서리 #공구 #해외</p>
							 	</div>
							</div>
						</div>
						<div class="col-lg-3 col-sm-6 col-12 card_display">
						...
						<div class="col-lg-3 col-sm-6 col-12 card_display">
							<div class="card s-Citem">
							 	...
							 	<div class="card-body">
							    	<p class="card-text">#페이스북 #잡화 #직구 #해외</p>
							 	</div>
							</div>
						</div>
						<div class="col-lg-3 col-sm-6 col-12 card_display">
							<div class="card s-Citem">
							 	...
							 	<div class="card-body">
							    	<p class="card-text">#페이스북 #잡화 #수제 #국내</p>
							 	</div>
							</div>
						</div>
						<div class="col-lg-3 col-sm-6 col-12 card_display">
