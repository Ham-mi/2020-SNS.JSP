			...
			<div class="row text-center">
				<div class="col-lg-12">
					<div class="home_content">
						<div class="home_title">트위터</div>
						<div class="index-over"><a href="../Main/index.jsp">Home</a> <i class="fa fa-angle-right" aria-hidden="true"></i> SNS <i class="fa fa-angle-right" aria-hidden="true"></i> <a href="../SNS/twitter.jsp">트위터</a></div>	
					</div>
				</div>
			</div>
		</div>
				...
				<div class="col">
					<div class="domain_pricing_content">
						<ul class="d-flex flex-md-row flex-column align-items-center justify-content-md-between justify-content-center nav nav-tabs">
						  ...
						  <li class="nav-item">
						    <a class="nav-link  nav-active" href="twitter.jsp"><i class="fab fa-twitter" aria-hidden="true"></i>  트위터</a>
						  </li>
						  <li class="nav-item">
					...
					<div class="row">
						...
						<div class="col-lg-3 col-sm-6 col-12">
							<div class="card s-Citem">
							 	...
							 	<div class="card-body">
							    	<p class="card-text">#트위터 #악세서리 #수제 #국내</p>
							 	</div>
							</div>
						</div>
						<div class="col-lg-3 col-sm-6 col-12">
							<div class="card s-Citem">
							 	...
							 	<div class="card-body">
							    	<p class="card-text">#트위터 #의류 #공구 #국내</p>
							 	</div>
							</div>
						</div>
						<div class="col-lg-3 col-sm-6 col-12">
							<div class="card s-Citem">
							 	...
							 	<div class="card-body">
							    	<p class="card-text">#트위터 #의류 #직구 #해외</p>
							 	</div>
							</div>
						</div>
						<div class="col-lg-3 col-sm-6 col-12">
							<div class="card s-Citem">
							 	...
							 	<div class="card-body">
							    	<p class="card-text">#트위터 #의류 #공구 #해외</p>
							 	</div>
							</div>
						</div>
						<div class="col-lg-3 col-sm-6 col-12">
							<div class="card s-Citem">
							 	...
							 	<div class="card-body">
							    	<p class="card-text">#트위터 #의류 #수제 #해외</p>
							 	</div>
							</div>
						</div>
						<div class="col-lg-3 col-sm-6 col-12">
							<div class="card s-Citem">
							 	...
							 	<div class="card-body">
							    	<p class="card-text">#트위터 #의류 #직구 #국내</p>
							 	</div>
							</div>
						</div>
						<div class="col-lg-3 col-sm-6 col-12">
							<div class="card s-Citem">
							 	...
							 	<div class="card-body">
							    	<p class="card-text">#트위터 #악세서리 #공구 #해외</p>
							 	</div>
							</div>
						</div>
						<div class="col-lg-3 col-sm-6 col-12">
						...
						<div class="col-lg-3 col-sm-6 col-12">
							<div class="card s-Citem">
							 	...
							 	<div class="card-body">
							    	<p class="card-text">#트위터 #잡화 #직구 #해외</p>
							 	</div>
							</div>
						</div>
						<div class="col-lg-3 col-sm-6 col-12">
							<div class="card s-Citem">
							 	...
							 	<div class="card-body">
							    	<p class="card-text">#트위터 #잡화 #수제 #국내</p>
							 	</div>
							</div>
						</div>
						<div class="col-lg-3 col-sm-6 col-12">
